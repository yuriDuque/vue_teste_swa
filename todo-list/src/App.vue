  ...
  <div id="app">
    <div class="ui inverted vertical masthead center aligned segment">
      <div class="ui text container">
        ...
        <h2 class="ui inverted header">Yuri Duque
          <div class="sub header">Desenvolvedor .net</div>
        </h2>
        <h3 class="ui inverted header">Minas Gerais, Brasil - 2020</h3>
        <a class="tiny ui linkedin button" type="button" href="https://www.linkedin.com/in/yuri-duque/">
